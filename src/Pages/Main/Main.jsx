    ...
    <>
      <div className='main'>
        <div className='slide-1'>
          <div data-aos="fade-right"><HomeSection
          ...
          /></div>
          <img src={Home1} alt='' className='slide-1-img' data-aos="fade-left"/>
        </div>
        <div className='slide-2'>
          <img src={groupIcons} alt='' className='slide-2-img' data-aos="fade-right"/>
          <div data-aos="fade-left"><HomeSection 
        ...
        <div className='slide-1'>
        <div data-aos="zoom-out-right"><HomeSection
        ...
        <div className='slide-3'>
            ...
            <img src={Resource} alt='' className='slide-2-img' data-aos="flip-right"/>
<div data-aos="flip-left"><HomeSection
     ...
     data-aos-duration="5000"><div className='email-box'>
            <h1>Wanna Join Us ?</h1>
        ...
        <div data-aos="zoom-in"><HomeSection
